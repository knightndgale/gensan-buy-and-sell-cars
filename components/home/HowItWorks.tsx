  ...
  return (
    <div className="container mx-auto max-w-7xl px-3 sm:px-4">
      <div className="mb-8 flex items-center gap-2">
        <Check className="size-4 sm:size-7 text-primary" />
      ...
      <p className="mb-10 text-xs sm:text-base text-muted-foreground">Making the buying process fast, easy, and predictable for buyers.</p>

      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {STEPS.map((step, i) => (
          <div key={step.title} className="flex flex-col items-center rounded-xl bg-white p-6 text-center shadow-sm">
            <div className="mb-2 flex size-10 shrink-0 items-center justify-center rounded-full bg-primary text-base font-bold text-primary-foreground sm:text-lg">{i + 1}</div>
