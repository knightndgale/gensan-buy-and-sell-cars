...
import { ArrowRight, Camera, CheckCircle2, Eye, FileText, Info, Cloud } from "lucide-react";
    ...
    <div className="flex flex-col gap-6">
          ...
          <CardContent className="flex items-center gap-4 p-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-sm opacity-90">
                List your car now and we&apos;ll connect you with interested buyers in GenSan
              </p>
            </div>
      ...
      <Card className="border-blue-200 bg-blue-50 dark:border-blue-900/50 dark:bg-blue-950/30">
        <CardContent className="flex gap-3 p-4">
          <div className="flex size-8 shrink-0 items-center justify-center rounded-full bg-blue-200/80 text-blue-700 dark:bg-blue-800/50 dark:text-blue-300">
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm text-blue-800/90 dark:text-blue-200/80 mt-1">
              You list your car here. When a buyer is interested, our team will contact you directly
              with the buyer&apos;s details. You don&apos;t need to worry about inquiries, we handle
              that for you.
            </p>
          </div>
        </CardContent>
